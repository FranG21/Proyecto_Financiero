...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-01-2020 a las 00:27:57
...
(5, 'saf', 'ert', 3, 3, 3, 0),
(6, 'ESCRITORIO', 'dsf', 3, 4, 3, 1),
(7, 'VEHICULO', 'V12', 12, 3, 5, 0),
...
(1, 'Jose Alberto', 'Morales Arias', '32323235-1', '1125-335644-354-11', '', '235-4512', 'Secretario', 'CuscatlÃ¡n', '2018-01-22', 'Colonia las margaritas pasaje las azucenas #123 cojutepeque,cuscatlan', 1, 0, 0),
...
(3, 'Oscar', 'Peraza', '02060298-1', '0012-19242-652-2', '', '7822-3473', 'Docente', 'San Salvador', '2019-01-21', 'soyapango col. la esperanza', 1, 1, 0),
(4, 'JUAN ALFREDO', 'ORTEZ HERNANDEZ', '234567-9', '1010-123456-106-1', NULL, '2222-3343', 'VENTA DE COSAS', 'AGUACHAPAN', '2019-12-28', 'ESTA DE EJEMPLO', 1, 0, 0);
...
(2, 'DEPARTEMENTO DE ADMINISTRACION', 'DA0002', 1);
...
--
ALTER TABLE `activo`
  MODIFY `idAc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `amortizacion`
--
ALTER TABLE `amortizacion`
  MODIFY `idAmortizacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
...
--
ALTER TABLE `prestamo`
  MODIFY `idPres` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
