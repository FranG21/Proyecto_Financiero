...
public class ModificarSubCategoria extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(500, 240, 110, 30);
        ...
        botonRegistrar.setBounds(380, 240, 110, 30);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarSubCategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarSubCategoria().setVisible(true);
            }
        });
    }
